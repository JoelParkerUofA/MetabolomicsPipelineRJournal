...
## ----Workflow, out.width = "100%", out.height = "30%", fig.cap = "Figure 1. MetabolomicsPipeline workflow"----
knitr::include_graphics("figures/Workflow.png")


## ----SEOrganization, out.width = "100%", out.height = "30%", fig.cap = "Figure 2. Organization of Metabolon Inc data into a SummarizedExperiment"----
